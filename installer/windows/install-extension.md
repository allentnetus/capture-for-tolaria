...
`v0.1.0-beta.4` 使用自包含 Installer ZIP 和 Chrome 开发者模式，不使用 Chrome Web Store。

1. 解压 `capture-for-tolaria-installer-v0.1.0-beta.4.zip`。
...
V0.1.x 不自动下载或执行新 Helper。Beta.4 构建未签名，用户应只从项目 Release 页面获取当前版本的自包含 Installer ZIP。
